...
#holds whether google had an up month true or false  second element in shape is = 2 because this is binary vector.  First one is none because we have no clue how much is in training data
...
# Al returns in a 2D array
# 1 0 indicates UP day
